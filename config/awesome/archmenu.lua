 local menu98edb85b00d9527ad5acebe451b3fae6 = {
     ...
     {"QtFM", "qtfm", "/usr/share//icons/hicolor/16x16/apps/qtfm.png" },
     {"Solaar", "solaar"},
     {"UHK Agent", "/usr/bin/uhk-agent ", "/usr/share//icons/hicolor/16x16/apps/uhk-agent.png" },
 ...
 local menu251bd8143891238ecedc306508e29017 = {
     {"Sasteroids", "sasteroids", "/usr/share/pixmaps/sasteroids.png" },
 }
 ...
 local menud334dfcea59127bedfcdbe0a3ee7f494 = {
     ...
     {"qimgv", "qimgv ", "/usr/share//icons/hicolor/16x16/apps/qimgv.png" },
 }
 ...
 local menuc8205c7636e728d448c2774e6a4a944b = {
     ...
     {"Cawbird", "cawbird", "/usr/share//icons/hicolor/16x16/apps/uk.co.ibboard.cawbird.png" },
     ...
     {"Ripcord", "ripcord", "/usr/share//icons/Ripcord_Icon.png" },
     ...
     {"Todoist", "todoist-nativefier", "/usr/share/pixmaps/todoist-nativefier.png" },
     {"Zoom", "/usr/bin/zoom ", "/usr/share/pixmaps/Zoom.png" },
     {"Zoom (Firefox)", "/usr/bin/zoom-firefox ", "/usr/share/pixmaps/Zoom.png" },
 ...
 local menudf814135652a5a308fea15bff37ea284 = {
     ...
     {"Todoist", "todoist-nativefier", "/usr/share/pixmaps/todoist-nativefier.png" },
     {"WorkFlowy", "env APPIMAGELAUNCHER_DISABLE=1 DESKTOPINTEGRATION=0 /opt/WorkFlowy-x86_64.AppImage", "/usr/share//icons/hicolor/16x16/apps/workflowy.png" },
 }

 local menue6f43c40ab1c07cd29e4e83e4ef6bf85 = {
     {"Beekeeper Studio", "/usr/bin/beekeeper-studio ", "/usr/share//icons/hicolor/16x16/apps/beekeeper-studio.png" },
     {"CMake", "cmake-gui ", "/usr/share//icons/hicolor/32x32/apps/CMakeSetup.png" },
     {"Electron", "electron ", "/usr/share/pixmaps/electron.png" },
     {"Electron 10", "electron10 ", "/usr/share/pixmaps/electron10.png" },
     ...
     {"Socket Wrench", "\"/opt/Socket Wrench/socketwrench\" ", "/usr/share//icons/hicolor/16x16/apps/socketwrench.png" },
 }
 ...
 local menuee69799670a33f75d45c57d1d1cd0ab3 = {
     ...
     {"Code42", "/opt/crashplan/bin/CrashPlanDesktop", "///opt/crashplan/bin/icon_app.png" },
